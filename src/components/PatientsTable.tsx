...
const PatientsTable: React.FC = () => <Table columns={columns} dataSource={data} pagination={{disabled: false, pageSize:4, position:['bottomLeft']}} onChange={onChange} />;
